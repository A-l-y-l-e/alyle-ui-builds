...
class LyError {
    ...
    constructor(renderer, el, _theme) {
        ...
        /** @type {?} */
        const className = _theme.addStyleSheet(STYLES, STYLE_PRIORITY$2).error;
