...
function HammerInput_tsickle_Closure_declarations() {
    /** @type {?} */
...
function HammerStatic_tsickle_Closure_declarations() {
...
function RecognizerStatic_tsickle_Closure_declarations() {
    /* TODO: handle strange member:
    new(options?: any): Recognizer;
    */
}
...
function HammerManager_tsickle_Closure_declarations() {
    /** @type {?} */
...
function HammerOptions_tsickle_Closure_declarations() {
    /** @type {?|undefined} */
