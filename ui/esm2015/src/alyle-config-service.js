...
export const /** @type {?} */ THEME_VARIABLES = new InjectionToken('ly.theme.variables');
export const /** @type {?} */ IS_CORE_THEME = new InjectionToken('ly.is.root');
