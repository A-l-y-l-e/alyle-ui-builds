import { ElementRef, ChangeDetectorRef, EventEmitter, Renderer2, OnDestroy, NgZone } from '@angular/core';
...
export declare class LyImageCropper implements OnDestroy {
    private _renderer;
    private theme;
    private elementRef;
    private cd;
    ...
    }, "root" | "imgContainer" | "area" | "defaultContent">;
