...
function RippleConfig_tsickle_Closure_declarations() {
    /** @type {?|undefined} */
...
export { Ripple };
function Ripple_tsickle_Closure_declarations() {
    /** @type {?} */
